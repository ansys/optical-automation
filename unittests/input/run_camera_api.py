...
from SPEOS_scripts.camera_sensor.define_cameras import Camera, IntensitySensor
...
def main():
    ...
    intensity.set_range(x_start=-59, x_end=41, y_start=-9, y_end=11)
    ...
    intensity.set_range(x_mirrored=True, y_mirrored=True)
