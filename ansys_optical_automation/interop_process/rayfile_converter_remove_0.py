...
from ansys_optical_automation.post_process.dpf_zero_flux_S_Z import DpfRayfile_zero


class RayfileConverter_zero(DpfRayfile_zero):
    """
    This class contains the methods to convert rayfile between speos and zemax
    """

    def __init__(self, file_path):
        DpfRayfile_zero.__init__(self, file_path)
    ...
    def __export_to_zemax(self):
        ...
        # Use real ray number
        zemax_spectrum_file.write(struct.pack("<I", self.real_ray_number))  # NbrRays
