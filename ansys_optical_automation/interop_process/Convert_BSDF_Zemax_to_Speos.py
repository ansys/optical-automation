            ...
            for k in range(nbTheta):
                ...
                for phi_idx in range(nbPhi):
                    ...
                    if newTheta > 90 or newTheta < 0:
                        ...
                        temp_bsdfDataSpeos[i][j][k][phi_idx] = bsdfValue
                        # if scatterType == "BRDF":
                        # bsdfDataSpeos[i][j][k][phi_idx]=bsdfValue
                        # else:
                        # bsdfDataSpeos[i][j][nbTheta - 1 - k][phi_idx] = bsdfValue
