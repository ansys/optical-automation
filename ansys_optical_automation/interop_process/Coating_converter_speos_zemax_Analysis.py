...
class Coating_converter_speos_zemax_Analysis():
    ...
    def check_wavelength_range(self,the_system,substrate_catalog,material_1,user_wavelength_min,user_wavelength_max,nb_wavelength):
        """
    ...
    def write_speos_coating_file(self,file_id1, name1,
    ...
    def __init__(self,coatingfilename, coatingfolder,
        ...
        for j in range(len(substrate_name)):
            ...
            material_2_name = "AIR"
            material_2 = ''
            wavelength_min, wavelength_max, wavelength_delta = self.check_wavelength_range(the_system, substrate_catalog,
            ...
            for i in range(coating_list_length):
                ...
                if not coating_name == 'None':
                    ...
                    for wavelength_index in range(nb_wavelength):
                        ...
                        nb_angle_of_incidence, coating_data = self.read_transmission_vs_angle_result(resultfullfilename, skip_lines,
                                                                                                coating_data)

                    self.write_speos_coating_file(file_id1, name1,
                                             nb_digits, nb_angle_of_incidence,
                                             nb_wavelength, wavelength_min, wavelength_max, speos_wavelength_units_um,
                                             coating_data)
                    print("File " + coatingfilename1 + " created")
                    ...
                    for wavelength_index in range(nb_wavelength):
                        ...
                        nb_angle_of_incidence, coating_data = self.read_transmission_vs_angle_result(resultfullfilename2,
                                                                                                skip_lines, coating_data)

                    self.write_speos_coating_file(file_id2, name2,
                                             nb_digits, nb_angle_of_incidence,
                                             nb_wavelength, wavelength_min, wavelength_max, speos_wavelength_units_um,
                                             coating_data)
