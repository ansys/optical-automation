...
class CoatingConverter:
    def __init__(
        ...
        zos = BaseZOS()
        self.the_system = zos.the_application.PrimarySystem
        sample_dir = zos.the_application.SamplesDir
        coating_dir = zos.the_application.CoatingDir
        # the_system = zos.the_system

        # Set up primary optical system
        coatingfullfilename = os.path.join(coatingfolder, coatingfilename)
        ...
        if not coatingfullfilename.lower() == destination_file.lower():
            ...
            bool_copy = 1
        # Make new file
        test_file = os.path.join(sample_dir, "coating.zos")
        # print(test_file)
        self.the_system.New(False)
        self.the_system.SaveAs(test_file)
        ...
        for substrate_name in substrate_names:
            material_1 = substrate_name
            material_2_name = "AIR"
            material_2 = ""
            wavelength_min, wavelength_max, wavelength_delta = self.check_wavelength_range(
                substrate_catalog, material_1, user_wavelength_min, user_wavelength_max, nb_wavelength
            )
            ...
            for i in range(coating_list_length):
                ...
                if not coating_name == "None":
                    ...
                    for wavelength_index in range(nb_wavelength):
                        ...
                        # the_system, resultfullfilename2)
                        # if bool_result == False:
                        # print("The result file was not created!")
    ...
    def check_wavelength_range(
        self, substrate_catalog, substrate_material, user_wavelength_min, user_wavelength_max, nb_wavelength
    ):
        """
